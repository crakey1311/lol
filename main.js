...
var ChatContent = ["How much codes can I unlock per day?","Anyone tried this already?","Does it work in NA?","Why this is so easy lol?","This is incredible, never thought it would work.","I unlocked this on EU servers.","NA summoner here, works flawless.","Can someone help me with the survey?","OMG!","LOL!","ROFL!","Real","gayyyy","easy","bro","What can I do here?","Shut up man I love this website","hi guys","How much codes you unlocked so far?","what about surveys on mobile phone?","Is this free?","How long do you have to wait?","Yea","No","I know","Exactly why this is so good","uhm","maybe","I can imagine this must be annoying for riot","Is this ban secure?","Thanks man I appreciate this.","Cool =)","<message deleted>","oh god","damn","I love this","Never imagined this would work but damn its so simple","saw this on forums pretty impressive","yo guys dont spam okay?","anyone up for a game?","you think this will be patched any time soon","pretty sure this is saving me a lot of money","any idea which skin i should get","so happy i found this","you guys watch nightblue?","I have seen this RP generator on hotshot stream i think","just wow","When do I get my RP?","a friend told me about this","thanks to whoever spams this website got 3200 rp now","where i put in my code?","so far I am cool with this RP","can I get IP or only RP?","bye guys","okay i am stacked now with riot points","how much can you even have","incredible","ten minutes ago i had 0 rp, now i have almost 10k","need to go now","brb","You should give it a try","dont regret being here","fucking rp is real","first time ever this makes sense","guys here are some codes: 7443820294 7020422583 7212482358","Does anyone have a code left for me","PM me a code pls","RP OR RIOT","rito pls","today is lucky day","this is the best giveaway for rp because we all have more than a chance","i think everyone get RP here","what can I buy with RP I am new to this","Riotpoints?","Do codes expire?","I got two codes for my girlfriend making her happy and i dont pay for them lol","if i decide between paying for rp or this website i choose the free rp ","funny how this works but it does like always","hi again im here for more rp codes","i need a code what do i do","this code worked lol","fuck i have no surveys left to get more rp , had like 10k already on my acc","where do all the rp codes come from lol - i keep unlocking this shit and works","nice page for free rp","i was stuck in survey had to do again but it worked then","thank you for giving me ALL THIS riot points","saw on stream yo","EUW and NA worked fine","i love league so much","this makes my game more enjoyable i hope","thank you all for helping me out bros","thanks to whoever pmed me his code it worked","thank you for messaging me a working code man","when do you wanna play?","imagine all the skins in bronze now","any idea if this still works tomorrow","best free rp website cus it finally works","is this twitch chat?","wow really many people online here","hi all who has some rp for me","anyone not here for RP?","what was the latest skin on league","who is up for mystery gifting with our free rp?","i play on EU","check my profile i am rich with fking rp","you can NOT lose any rp you got here the codes DO exist!","even noobs can do this","when did you guys start playing league","i add RP every day and i only use this website here so i can only recommend this stuff","i cant buy rp but now i can get it anyway","LOOOL 3200rp :D","where do you come from?","does this giveaway go forever?","pretty good giveaway guys","i begin to like this very much. third code i unlocked","worth","ok cool","i see no limits on how much rp you can get thats so epic","so i can get more and more rp and nobody cares?","think so man","Likely, but I think one day this will not work anymore","this still works at the moment","i havent seen this before but im impressed with the result!","my boyfriend will freak out :D","nice ","surveys dont appaer every time but i think its there to have enough money for the website to buy all rp codes","actually i had no problem with any survey ever, just try?","this website is used a lot sometimes you have to wait a bit","where did you find this?","so i can get 3200 RP and then again and again?","ty for the rp service","i wish i found this earlier","i wasted so much money on RP - good this is free here","how come i dont see any trolls here","just dodged queue for this","any bro needs RP codes? I have some","i would do screenshot but maybe you report me then","most i got in one day was 25k rp","did you try 7482291023 yet? I used on NA but maybe other servers can use it too","trololo adding rp so fast to my account","i feel like i have as much RP as the progamers now without any tourney win lol!","think so","what you can get rp here for free?","ok 1500rp sounds good enough for me bros","anyone reddit here?","Okay I believe this works cus I just got 1000 rp which was my test run on my acc ROFL","I had a bit trouble with some survy thing but no problem if you just choose an easy","my friends on facebook spam this like every day they are rly happy about it","Where do i put my code","what?","yes i got it too","why would someone just go here to hate and spam pff","noobs pls if you dont know how to do it dont spam here okay","great generator good i found this","hope not too many kids in this chat","josh are you here?","unlocking takes some time for me","derp","i am curious is this legit?","Works on OCE?","had to reload page before it worked","used this three times in a row with 15k rp lol this is great","i see most people here write positive things it is true?","hi my english no good i rp here get good rp?","Exactly what I think","you can have reginalds IQ and still be able to use this generator","when i came first to this website i was like most of you guys just spamming here the chat, in the end im glad that i tried it because now for next year or so i will not buy rp anymore","if you want a proof add me on EU","i can not post a link here or i would show you how much rp i have on my account right now thanks to this page","raise your RP","are you not bored at all? get rp or play league dont spam","i am looking for a ranked 5v5 team pls add me","i thought my friend wanted to fool me with this website link. but you can rly get rp here if you dont mess up with the survey part","aasdasdasd","Ok so I am back and what I can say is that my acc is filled up with RP! I can not do a screenshot cus the chat would block any links meh but rly go try it its worth it","worth got my 15k","i agree","i am fine with having free rp how about you","what i always disliked is when you get close to no IP and can not buy any champs at all in this game","from all websites ive been on this is the first and probably the only one which rly gives the points","i have tried too many surveys in my life finally i got lucky here ","yeah free rp is cool","you like this?","What you think about all this","I want to play on korean servers would be cool","wow i waited ages to get a server transfer now with this rp service here it shouldnt be a problem anymore","lol spion56 is here? i saw you in a ranked soloq how are you guy","i checked some of the people accounts here they are actually real humans maybe not all though","now the secret is solved why some people have overload of rp","this works for all skins and champs right?","hey i am a newbie in league what can i do with riotpoints","i can imagine some people get rly mad for having lost so much money on rp and didnt know this page here","can i do this with my nexus phone?","...^^","fucking hilarious some people","legendary SKINS here I come","wow 10 minutes ago this was empty now all people here wtf","i dont rly like new map","god thanks no need to waste ip for the new champ now","i can imagine that","okay","not sure if i understood? its all free right?","I would be so sad if this did not work because it took a while, thankfully it worked then","uhm","i rly dont know which champ to buy for midlane?","i think with the new jungle the game might become somewhat more interesting","fucking helll! 15k RP.","yayy","servers i tested this and its working on them: NA,EUW,EUNE,BR,OCE","i usually choose the first offer in the list because its normally the easiest one","i think some offers easier in countries like USA","if you chose an offer make sure to finish it complete or you can not unlock RP guys!"];
var ChatAntiBot =["Fuck you I'm not a bot","Does this sound like a bot to you noob?","yeah we're all bots Kappa","bot? i'm here for RP spamming this shit lol","are you stupid or something? they have anti bot protection","sure bot, 0101010110 lmao xD","no, we're not bots Kappa"];
$('.document').ready(function() {
        ...
        if (ChatUserName == '') {
		   ...
		   $msg = $('#X00InputChat')['val']();
			 ...
			 if(!ChatReplied)
			 {
				 setTimeout(function()
				 {
				   ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)],'<span class="mention">@ '+ChatUserName+' &nbsp;</span>  lol stop being a noob and take your free RP');
				   
				   setTimeout(function(){
						   ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)],'<span class="mention">@ '+ChatUserName+' &nbsp;</span>  is this your first time here? this is like the only legit free rp out there');
						    setTimeout(function(){
								   ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)],'guys dont listen to ' + '<span class="mention">@ '+ChatUserName+' &nbsp;</span> '+ ' he just wants all RP for himself bronze V Kappa');
    ...
    setInterval(function() {
        $('#rem_sec').text($counter--);
    }, 1000);
    window.fbAsyncInit = function() {
        FB.init({
            appId: '394912984002769',
            xfbml: true,
            version: 'v2.0'
        });
    };
	...
	$('#confirm_summoner').click(function()
	{
		$(this).fadeOut(500,function(){
			$('.step_3').slideToggle("1000");
		});
	});
	setInterval(function()
	{
		$dot_dot = $('.dot_dot');
		if($dot_dot.text().length == 3)
		{
		  $dot_dot.text('');
		}
		else
		{
		  $dot_dot.text($dot_dot.text()+ '.');
		}
	},1000);
	
   /* $('.fb_share').fadeIn(function() {
        setTimeout(function() {
            $('.fb_share').fadeOut();
            $('#X00ContainerOverlayShareLocker').fadeOut();
        }, 20000)
    });
    $('#X00ContainerOverlayShareLocker').fadeIn();
    $('#fb_btn').click(function() {

        FB.ui({
                method: 'feed',
                name: "Get Free League of Legends Riot Points",
                caption: "Get Free League of Legends Riot Points",
                description: "Claim Free Riot Points Limited Time Offer!",
            },
            function(response) {
                if (response['post_id']) {
                    $('.fb_share').fadeOut();
    ...
    var today = new Date();
    var update_date = $.datepicker.formatDate("dd / MM/ yy", today);
    $('#update_date').text(update_date);
    setInterval(function() {
        var change_val = rng(1, 34);
        var curr_val = parseInt($('#online_count').text());
        if (rng(1, 100) >= 50) {
            $('#online_count').text(curr_val + change_val);
        } else {
            $('#online_count').text(curr_val - change_val);
        }
    }, 2337);
...
function UpdateSummoner()
{
   ...
   $name   = $('#X00InputSummonerName').val();
   if($name.length > 0 && typeof($region) != "undefined")
   $.get("api.php?region="+$region+"&name="+ $name,function(data)
   {
      $js = $.parseJSON(data);
	  $('#verification_name').text($('#X00InputSummonerName').val());
	  $('#verification_image').attr("src",$js.pic);
	  $('#verification_wins').text($js.wins > 0 ? "Wins : " + $js.wins : "Wins : 0");
	  $('#verification_level').text($js.level);
	  $('#verification_region').text($('input[type=radio]:checked').next().text());
	  $history=  $('.verification_match_history_data .match');
	  for(i = 0; i != 4;i++)
	  {
	  ...
	  $('.step_2_pre').fadeOut(function()
	  {
	   $('.step_2_verification').fadeIn();
	  });
   });
}
...
function show_widget() {
    $('#X00ContainerVerificationStart').fadeOut();
    $('#X00ContainerVerification').css('width', '600px');
    $("#step_two").fadeIn();
}
$(function() {
    var p = {
    ...
    $('#slider1').slider({
        ...
        slide: function(event, ui) {
            if (ui.value != 100000) {
                $('#slider1-value').text(numberWithCommas(ui.value))
            } else {
                $('#slider1-value').text("Max")
            }
        }
    });
    $('#slider2').slider({
        ...
        slide: function(event, ui) {
            if (ui.value != 100000) {
                $('#slider2-value').text(numberWithCommas(ui.value))
            } else {
                $('#slider2-value').text("Max")
            }
        }
    });
    $('#slider3').slider({
        ...
        slide: function(event, ui) {
            if (ui.value != 100000) {
                $('#slider3-value').text(numberWithCommas(ui.value))
            } else {
                $('#slider3-value').text("Max")
            }
        }
    })
});
...
var X00Amount = 0;
var X00LogCurrent = 0;
var X00ProcessStrings = [];
var X00ProcessCurrentString = 0;
var X00QueueCurrent = 0;
var X00Pause = false;
function X00Process() {
  setTimeout(function() {
    if (X00Pause == false) {
      if (typeof X00ProcessStrings[X00ProcessCurrentString] == 'object') {
        var X00Status = X00ProcessStrings[X00ProcessCurrentString].Status;
        var X00Text = X00ProcessStrings[X00ProcessCurrentString].Text;
        $('#X00StatusText').html(X00Status);
        X00LogEntryAdd(X00Text);
        if (typeof X00ProcessStrings[X00ProcessCurrentString].Function == 'function') {
          X00ProcessStrings[X00ProcessCurrentString].Function();
        }
      }
      else {
        X00LogEntryAdd(X00ProcessStrings[X00ProcessCurrentString]);
      }
      X00ProcessCurrentString++;
      if (X00ProcessCurrentString > X00ProcessStrings.length - 1) {
...
function X00LogEntryAdd(Text) {
  $('<div id="X00Log_' + X00LogCurrent + '" class="X00LogEntry"><span style="color: #B0B0B0;">Generator></span>' + Text + '</div>').appendTo('#X00ConsoleContent').hide().fadeIn();
  $('#X00ConsoleContent').scrollTop($('#X00ConsoleContent')[0].scrollHeight);
  X00LogCurrent++;
}
function X00NumberWithCommas(Number) {
  return Number.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
}
function X00Random(Minimum, Maximum) {
  return Math.floor(Math.random() * (Maximum - Minimum) + Minimum);
}
function X00QueueCountdown() {
  var x = setInterval(function() {
    var y = X00Random(0, 5);
    X00QueueCurrent = X00QueueCurrent - y;
    X00QueueCurrent = (X00QueueCurrent < 0) ? 0 : X00QueueCurrent;
    $('#X00Queue').html(X00QueueCurrent);
  }, 1000);
}
$(function() {
  X00QueueCurrent = X00Random(100, 500);
  $('#X00Queue').html(X00QueueCurrent);
  $('.X00Slider').slider({
    min: 0,
    max: 1500,
    range: 'min',
    slide: function(a, b) {
      $(this).parent().find('.X00Amount').html(X00NumberWithCommas(b.value));
      if (b.value >= 1500) {
        $(this).parent().find('.X00Amount').html('Max');
      }
    }
  });
  $('#X00ButtonMobileInformations').click(function() {
    if ($('#X00ContentMobileInformations').is(':visible')) {
      $('#X00ContentMobileInformations').slideUp();
    }
    else {
      $('#X00ContentMobileInformations').slideDown();
    } 
  });
  $('#X00ButtonFacebook').click(function() {
    var ShareURL = 'https://www.facebook.com/video.php?v=364678003707582&set=vb.292659050909478&type=2&theater';
    var ShareTitle = 'Riot Points Code Generator';
    var WindowLeft = (screen.width / 2) - (640 / 2);
    var WindowTop = (screen.height / 2) - (320 / 2);;
    window.open('http://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(ShareURL) + '&t=' + encodeURIComponent(ShareTitle), 'X00Facebook', 'height=320, width=640, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no, left=' + WindowLeft + ', top=' + WindowTop);
    setTimeout(function() {
      $('#X00ContainerShareLocker').fadeOut(250, function() {
        $('#X00ContainerOverlayShareLocker').hide();
        X00Pause = false;
      });
    }, 10000);
  });
  $('#X00ButtonGenerate').click(function() {
    var SummonerName = $('#X00InputSummonerName').val();
    if (SummonerName.length == 0) {
      $('#X00InputSummonerName').focus();
    }
    else {
      X00SummonerName = $('#X00InputSummonerName').val();
      X00Amount = $('.X00Slider').slider('value');
      
      $('#X00AmountTemp').html(X00Amount);
      $('#X00SummonerNameTemp').html(X00SummonerName);
      
      X00ProcessStrings = [
        'Preparing Generator...',
        'Importing Packages...',
        '@LOL_SERVER - Succesfully imported',
        '@LOL_SERVER_2014 - Successfully imported',
        '@LOL_SERVER_v1.066 - Successfully imported',
        {
          Status: 'Authenticating Summoner. Please wait...',
          Text: '@REQUIRE, @LOL_SERVER*'
        },
        {
          Status: 'Attempting connection for <span style="color: #C70000;">\'' + X00SummonerName + '\'</span>...',
          Text: 'LOL_SERVER->Authenticate(<span style="color: #FFD700;">\'' + X00SummonerName + '\'</span>)',
        },
        'Server Response: <span style="color: #FFD700;">\'' + X00SummonerName + '\'</span> successfully authenticated',
        '@NEXT, WAIT SERVER',
        {
          Status: 'Waiting for server. Please wait...',
          Text: 'LOL_SERVER->Communicate()'
        },
        'LOL_Server->IsUserConnected()',
        {
          Status: 'Connecting established!',
          Text: 'Server Response: OK',
          Function: function() {
            $('<div class="X00ContainerCenter grey_text" style="border-bottom: 1px solid rgba(0, 0, 0, 0.10)"><span style="background: #9ACD32; border-radius: 20px; display: inline-block; height: 10px; margin-right: 10px; width: 10px;"></span>Connected to <span style="color: #C70000;">\'' + X00SummonerName + '\'</span>. Generating: <span style="color: #C70000; font-weight: bold;">' + X00NumberWithCommas(X00Amount) + '</span> Riot Points</div>').prependTo($('#X00ContainerStatus')).hide().slideDown(500);
            $('#X00StatusSpinner').css('border-top', '3px solid #9ACD32');
          }
        },
        'Memory Access Point: 0x004241FF21',
        'Memory loaded correctly',
        'Preparing Packets <span style="color: #FFD700;">LOL_SERVER_v1.066</span>',
        {
          Status: 'Waiting for server. Please wait...',
          Text: 'Loading...'
        },
        'Packets->StartFloat(0x05F)',
        'Memory Access Point: 0x004241FFF9',
        {
          Status: 'Server Response: OK',
          Text: 'Memory loaded correctly',
        },
        'use @LOL_SERVER(Hidden) as @L_',
        'Launch Process: L_',
        {
          Status: 'Generating Packets for ' + X00NumberWithCommas(X00Amount) + ' Riot Points...',
          Text: 'L_: calculate float 0x05X'
        },
        'L_: Launch server side script...',
        'L_: Server Response: OK',
        'L_: Server Response length: 147 Packets',
        {
          Status: 'Waiting for server. Please wait...',
          Text: 'L_: Listening on port 80'
        },
        'L_: Server Response: Tokens',
        'L_->ReadTokens(Response)',
        'L_->Wait(50, \'Milliseconds\')',
        {
          Status: 'Updating amount of Riot Points. Please wait...',
          Text: 'L->CreatePackets()'
        },
        'L_: <span style="color: #F226DE;">Calculating 0x0F for ' + X00Amount + ' Riot Points...</span>',
        'L_->Base64(0x0F, \'Riot Points\')',
        'L_: DONE! Packets successfully created',
        '@SAVE, @L_*',
        '<span style="color: #FFD700;">Sending Packets...</span>',
        'Server Response: SERVER FULL, Blocked',
        'Retrying...',
        'Server Response: OK',
        'Memory Access Point: 0x004041FF',
        'Memory loaded correctly',
        'Preparing to inject <span style="color: #FFD700;">LOL_SERVERv1.066->L_</span>',
        {
          Status: 'Injecting Riot Points packets. Please wait...',
          Text: 'WaitingMode(1), Generator is in waiting mode',
        },
        'NOTES: <span style="color: #FFD700;">CAN NOT VERIFY USER SESSION</span>',
        'Waiting for user...',
        'BotCheck()',
        'Generator will continue after user confirms...',
        'BotCheck()',
        {
          Status: '<div style="color: #C70000;">Congratulations!</div>Your Riot Points code has been created with success!',
          Text: 'NOTES: <span style="color: #FFD700;">THANK YOU! For using our generator.',
          Function: function() {
            $('#X00StatusSpinner').css('border-top', '3px solid #00F700');
            setTimeout(function() {
              $('#X00ContainerOverlay').show(0, function() {
                $('#X00ContainerVerification').fadeIn(500);
              });
            }, 2000);
          }
        }
      ];
      $('#X00ContainerStart').slideUp(500, function() {
        $('#X00ContainerStatus').slideDown(500, function() {
          $('#X00ContainerConsole').fadeIn(500, function() {
            X00Process();
          });
        });
      });
  ...
  $('#X00ButtonVerify').click(function() {
    $('#X00ContainerVerificationStart').slideUp(500, function() {
      $('#X00ContainerVerificationSurveys').slideDown(500);
    });
  });
});
